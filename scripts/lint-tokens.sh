...
EX='lib/themes|app/globals\.css|components/theme/|app/\(admin\)|components/admin/|app/api/og|components/marketing/|app/page\.tsx|app/pricing/|app/themes/|app/discover/|app/menu-import/'
